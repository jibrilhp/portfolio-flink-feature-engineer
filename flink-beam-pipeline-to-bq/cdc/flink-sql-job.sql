...
-- Sink Table: BigQuery via JDBC
CREATE TABLE bigquery_users_sink (
    id BIGINT,
    name STRING,
    email STRING,
    created_at STRING,
    ...
    'connector' = 'bigquery',
    'project-id' = 'data-dev-270120',
    'dataset' = 'datahub',
    'table' = 'users_sink',
    'service-account' = '/opt/flink/gcp-credentials/service-account.json',
    'delivery-guarantee' = 'EXACTLY_ONCE',
    'table-create-if-not-exists'='true'

);

INSERT INTO bigquery_users_sink
SELECT id, name, email, created_at, updated_at, __op AS operation, __ts_ms AS ts_ms
FROM kafka_users;
