...
public class PropertyInteractionPipeline {
    public static void main(String[] args) {
        ...
        String kafkaTopic = "property-interactions";
        String bigQueryTable = "your-project:your_dataset.property_interaction"; // Change as needed
